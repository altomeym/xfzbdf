              ...
              <td>
                ...
                <div class="product-info">
                  ...
                  @if ($order->shop->feedbacks->count())
                    @include('theme::layouts.ratings', ['ratings' => $order->shop->ratings, 'count' =>
                    $order->shop->ratings_count])
                  @else
                ...
                <td>
                  ...
                  @else
                    ...
                    <div class="post-review-box">
					  ...
					  {{-- div added by hassan00942 + reviewUiLookLikeFiver00942 --}}
                      <div class="product-info-rating feedback-stars mb-3 mt-3">
                        <div>@lang('theme.seller_communication_level')</div>
                        <span class="star rated" data-toggle="tooltip" data-title="@lang('theme.hate_it')" data-value="1">
                          <i class="fas fa-star fa-fw"></i>
                        </span>
                        <span class="star rated" data-toggle="tooltip" data-title="@lang('theme.not_so_good')" data-value="2">
                        ...
                        <span class="response small text-primary">@lang('theme.love_it')</span>
                        {{ Form::hidden('items[' . $item->pivot->inventory_id . '][rating_seller_communication_level]', 5, ['class' => 'rating-value']) }}
                      </div>
                      {{-- div added by hassan00942 + reviewUiLookLikeFiver00942 --}}
                      <div class="product-info-rating feedback-stars mb-3">
                        <div>@lang('theme.recommend_to_a_friend')</div>
                        <span class="star rated" data-toggle="tooltip" data-title="@lang('theme.hate_it')" data-value="1">
                          <i class="fas fa-star fa-fw"></i>
                        </span>
                        <span class="star rated" data-toggle="tooltip" data-title="@lang('theme.not_so_good')" data-value="2">
                        ...
                        <span class="response small text-primary">@lang('theme.love_it')</span>
                        {{ Form::hidden('items[' . $item->pivot->inventory_id . '][rating_recommend_to_a_friend]', 5, ['class' => 'rating-value']) }}
                      </div>
                      {{-- div added by hassan00942 + reviewUiLookLikeFiver00942 --}}
                      <div class="product-info-rating feedback-stars">
                        <div>@lang('theme.service_as_descrived')</div>
                        <span class="star rated" data-toggle="tooltip" data-title="@lang('theme.hate_it')" data-value="1">
                          <i class="fas fa-star fa-fw"></i>
                        </span>
                        <span class="star rated" data-toggle="tooltip" data-title="@lang('theme.not_so_good')" data-value="2">
                        ...
                        <span class="response small text-primary">@lang('theme.love_it')</span>
                        {{ Form::hidden('items[' . $item->pivot->inventory_id . '][rating_service_as_described]', 5, ['class' => 'rating-value']) }}
                      </div>
                    </div> <!-- /.post-review-box -->
                  @endif
                </td>
