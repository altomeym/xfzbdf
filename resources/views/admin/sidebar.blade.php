    ...
    <ul class="sidebar-menu">
      ...
      @if (Gate::allows('index', \App\Models\Category::class) || Gate::allows('index', \App\Models\Attribute::class) || Gate::allows('index', \App\Models\Product::class) || Gate::allows('index', \App\Models\Manufacturer::class) || Gate::allows('index', \App\Models\CategoryGroup::class) || Gate::allows('index', \App\Models\CategorySubGroup::class))
        <li class="treeview {{ Request::is('admin/catalog*') ? 'active' : '' }}">
          ...
          <ul class="treeview-menu">
            ...
            @can('index', \App\Models\AmongMyBrand::class)
              <li class="{{ Request::is('admin/catalog/among-my-brand*') ? 'active' : '' }}">
                <a href="{{ url('admin/catalog/among-my-brand') }}">
                  <i class="fa fa-angle-double-right"></i> {{ trans('nav.among_my_brands_admin') }}
                </a>
              </li>
            @endcan
      ...
      @if (is_incevio_package_loaded('wallet'))
        ...
        @if (Auth::user()->isMerchant())
		  ...
		  <li class="{{ Request::is('admin/shop-appearance*') ? 'active' : '' }}">
			<a href="{{ route('admin.shop-appearance') }}">
			  <i class="fa fa-palette"></i>{{ trans('app.shop_appearance') }}
			</a>
		  </li>
      ...
      <li class="treeview {{ Request::is('admin/setting*') ? 'active' : '' }}">
        ...
        <ul class="treeview-menu">
            ...
            @can('index', \App\Models\SubscriptionPlan::class)
              <li class="{{ Request::is('admin/setting/subscriptionPlan*') ? 'active' : '' }}">
                <a href="{{ url('admin/setting/subscriptionPlan') }}">
                  <i class="fa fa-angle-double-right"></i> {{ trans('app.subscription_plans') }}
                </a>
              </li>
            @endcan
          @endif
          ...
          @if (Auth::user()->isAdmin())
            ...
            <li class="{{ Request::is('admin/setting/country-wise-website*') ? 'active' : '' }}">
              <a href="{{ url('admin/setting/country-wise-website') }}">
                <i class="fa fa-angle-double-right"></i> {{ trans('app.country_websites') }}
              </a>
            </li>
          @endif
         ...
         @if (Gate::allows('index', \App\Models\Page::class) || Gate::allows('index', \App\Models\TeamMember::class) || Gate::allows('index', \App\Models\TeamPageSetting::class) || Gate::allows('index', \App\Models\GuideLead::class) || Gate::allows('index', \App\Models\Review::class) || Gate::allows('index', \App\Models\EmailTemplate::class) || Gate::allows('index', \App\Models\Blog::class) || Gate::allows('index', \App\Models\Faq::class))
        <li class="treeview {{ Request::is('admin/utility*') ? 'active' : '' }}">
          ...
          <ul class="treeview-menu">
            ...
            @can('index', \App\Models\TeamMember::class)
              <li class="{{ Request::is('admin/utility/team-member*') ? 'active' : '' }}">
                <a href="{{ url('admin/utility/team-member') }}">
                  <i class="fa fa-angle-double-right"></i> {{ trans('nav.team_members') }}
                </a>
              </li>
            @endcan
			
            {{-- added by hassan00942 + teamPage00942 --}}
            @can('index', \App\Models\TeamPageSetting::class)
              <li class="{{ Request::is('admin/utility/team-page-setting*') ? 'active' : '' }}">
                <a href="{{ url('admin/utility/team-page-setting') }}">
                  <i class="fa fa-angle-double-right"></i> {{ trans('nav.team_page_setting') }}
                </a>
              </li>
            @endcan
			
			@can('index', \App\Models\GuideLead::class)
              <li class="{{ Request::is('admin/utility/guide-lead*') ? 'active' : '' }}">
                <a href="{{ url('admin/utility/guide-lead') }}">
                  <i class="fa fa-angle-double-right"></i> {{ trans('nav.guide_leads') }}
                </a>
              </li>
            @endcan

			  <!-- the develope not creted the permission -->
			@can('index', \App\Models\Review::class)
                <li class="{{ Request::is('admin/utility/reviews/add_fake*') ? 'active' : '' }}">
                  <a href="{{ route('admin.utility.reviews.add_fake') }}">
                    <i class="fa fa-angle-double-right"></i> Add reviews
                  </a>
                </li>    
                
                <li class="{{ Request::is('admin/utility/reviews/add_csv*') ? 'active' : '' }}">
                  <a href="{{ route('admin.utility.reviews.add_csv') }}">
