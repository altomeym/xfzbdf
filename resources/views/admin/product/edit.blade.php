    ...
    @else
      ...
      <div class="tab-content row justify-content-center">
        ...
        <div class="col-md-8 tab-pane fade in active" id="overview">
          {!! Form::model($product, ['method' => 'POST', 'route' => ['admin.catalog.product.update', $product->id], 'id' => 'overview-form', 'data-toggle' => 'validator-']) !!}
        ...
        <div class="col-md-8 tab-pane fade" id="description">
          {!! Form::model($product, ['method' => 'POST', 'route' => ['admin.catalog.product.update_description_faqs'], 'id' => 'description-faqs', 'data-toggle' => 'validator-']) !!}
        ...
        <div class="col-md-8 tab-pane fade" id="requirements">
          {!! Form::model($product, ['method' => 'POST', 'route' => ['admin.catalog.product.update_requirements'], 'id' => 'requirements-form', 'data-toggle' => 'validator-']) !!}
        ...
        <div class="col-md-8 tab-pane fade" id="gallery">
          {!! Form::model($product, ['method' => 'POST', 'route' => ['admin.catalog.product.update_gallery'], 'files' => true, 'id' => 'gallery-form', 'data-toggle' => 'validator-']) !!}
