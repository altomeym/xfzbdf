...
elseif (isset($event)) {
    ...
    $SEOdescription = substr($event->excerpt, 0, config('seo.meta.description_character_limit', 160));
...
// For team page + teamPage00942
elseif (isset($team)) {
    $SEOtitle = $team->meta_title;
    $SEOdescription = substr($team->meta_description, 0, config('seo.meta.description_character_limit', 160));
    $SEOkeywords = $team->meta_keywords;
}
