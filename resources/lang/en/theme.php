...
return [
    ...
    'button' => [
        ...
        'choose_from_categories' => 'Choose From Services',
        'clear'             => 'Clear',
        'contact'             => 'Contact',
        'contact_seller' => 'Contact Seller',
        'continue_shopping' => 'Other Services',
        'confirm_goods_received' => 'Confirm Service Received',
        'delete'             => 'Delete',
        'details'             => 'Details',
        'go_back'            => 'Go Back',
        'give_feedback'     => 'Give Feedback',
        'got_it' => 'Got It', // added by hassan00942
        'login'             => 'Login',
        ...
        'shop_now'             => 'Shop Now',
        'shop_from_other_categories' => 'Order another services',
        'subscribe'         => 'Subscribe',
        'submit'            => 'Submit',
        ...
        'view_product_details' => 'View Service Details',
	...
	'budgets' => 'Budgets',// added by hassan00942 + taskChangeCatLayout00942
	'delivery_options' => 'Delivery Options',// added by hassan00942 + taskChangeCatLayout00942
	'delivery_options' => 'Delivery Options',// added by hassan00942 + taskChangeCatLayout00942
	'no_review' => 'No Review',// added by hassan00942 + taskChangeCatLayout00942
	'how_work' => 'How :site_name works',// added by hassan00942 + taskChangeCatLayout00942
	'any' => 'Any',// added by hassan00942 + taskChangeCatLayout00942
	'starting_at' => 'STARTING AT',// added by hassan00942 + taskChangeCatLayout00942
	'min' => 'Min',// added by hassan00942 + taskChangeCatLayout00942
	'max' => 'Max',// added by hassan00942 + taskChangeCatLayout00942
    ...
    'contact_support' => 'Contact Support', // added by hassan00942
    'checkout' => 'Checkout',
    'condition' => 'Condition',
    ...
    'custom_shipping' => 'Custom Delivery',
    ...
    'full_name' => 'Full Name',
    'gift_cards' => 'Gift Cards',
    'goods_received' => 'Service received',
    'grid_view' => 'Grid View',
    ...
    'hello' => 'Hello',
    'home' => 'Home',
    'how_was_the_product' => 'How was the Delivery?',
    ...
    'main_searchbox_placeholder' => 'What services are you looking for today?',
    ...
    'no_product_found' => 'No service found',
    ...
    'product' => 'Service',
    'products' => 'Services',
    'product_desc' => 'Service Description',
    ...
    'return_and_refund_policy'     => 'Return and Refund Policy',
    'review' => 'Review',
    'reviews' => '{0,1} :count Visit|{2,*} :count Visits',
    'running' => 'Running',
    'search' => 'Search',
    ...
    'ship_to' => 'Your Information',
    'shipping' => 'Delivery',
    'shipping_options' => 'Delivery options',
    'shipping_address' => 'Billing Information',
    'shipping_cost' => 'Delivery Fee',
    'shop_by' => 'Shop by',
    'shoping_cart' => 'Service Cart',
    'sing_in' => 'Hello, Sign in',
    'sold_by' => 'Fulfilled by',
    'sort_by' => 'Sort by',
    ...
    'help' => [
        ...
        'customer_paid' => 'You paid <strong><em> :amount </em></strong>, inclusive all taxes, delivery charges and others.',
        ...
        'how_to_open_a_dispute_second_step' => 'You can choose between two options: <br/><br/><em>Refund Only</em> – this means that either you did not receive the service and you’re applying for a full refund or you did receive the service and you want a partial refund (without having to use the delivery), OR <br/><br/><em>Return Service</em> – this means that you want to cancel the service and apply for a full refund.',
        ...
        'reason_to_return_goods' => '- I am not satisfied with the service I received and would like to cancle it for a full refund. <small>(You may have to pay the return delivery cost)</small>',
        'reason_to_refund_request' => '- I haven\'t received my order and I would like to get my money back.<br/>- The service is not as described and I would like a partial refund.',
        'return_goods_help_txt' => 'If the seller accepts your proposal, you will be asked to not to use the delivery files you received.',
    ...
    'notify' => [
        ...
        'order_will_ship_to' => 'We\'ll start to work on your order soon!',
        ...
        'select_shipping_address' => 'Select Billing address.',
        'shipping_cost_may_change' => 'Delivery cost may change for the aditional work.',
        'seller_doesnt_ship' => 'This seller does not deliver to your selected Country/Region. Change the billing address or find other sellers who bill to your order.',
        ...
        'all_seller_doesnt_ship' => 'All seller does not deliver to your selected Country/Region. Change the billing address or find other sellers who bill to your order.',
    ...
    'placeholder' => [
        ...
        'message_to_seller_2' => 'Ask a question or share your project description and budget so you will entertain better.', // added by hassan00942
        'name' => 'Your Name',
        'nice_name' => 'Nice Name',
        'password' => 'Password',
    ...
    'validation' => [
        ...
        'dispute_product_id_required_with' => 'Select the services that have an issue.',
    ...
    'section_headings' => [
        ...
        'bought_together' => 'Frequently bought together',
        'give_feedbacks_to_products' => 'Give Feedbacks to Services',
        ...
        'key_features' => 'What do we deliver <span class="text-primary">in this order?</span>',
        ...
        'select_from_categories' => 'Select From <span class="text-primary">Services</span>',
    ...
    'select_from_categories' => 'Services',
    ...
    'benefit' => [
        ...
        'two' => [
            ...
            'detail' => 'Get a holistic and detailed view of your business to better understand sales, orders, and customers to better tailor your services.',
        ],
        'three' => [
    ...
    'plan' => [
        'inventory_limit' => ':limit Services',
    ...
    'how_it_work_steps' => [
        ...
        'step_2' => [
            ...
            'detail' => 'Listing your service is really simple through our easy to use the self-serve portal. Upload including high-quality service images and additional details.',
        ],
        'step_3' => [
    ...
    // Version 2.0.0
    'add_shipping_address' => 'Add a billing address',
    'archive' => 'Archive',
    'country' => 'Country',
    'delivery_locations_info' => 'Delivery options and delivery time may vary for different services',
    'choose_delivery_location' => 'Choose Billing Country',
    'edit' => 'Edit',
    ...
    'std_delivery_time' => 'Estimated Delivery Time: 4 - 9 days',
    ...
    'cancelled' => 'Cancelled',
    'returned' => 'Returned',
    'select_cancel_items_required' => 'Select the service(s) you want to cancel.',
    'sale_count' => 'Sold: :count',
    'login' => 'Sign In',
    'weekly_offer' => 'Offers of the Week',
    'see_more' => 'See More',
    'more_from_shop' => 'More Service from Tiejet',
    'welcome' => 'Welcome To',
    'support' => 'Support',
    'wallet' => 'Wallet',
    'new_item' => 'New',
    ...
    'hot_products' => 'Pro Services',
    'trending_products' => 'Selected Trending Services',
    ...
    'search_product_and_supplier' => 'Search Services',
    ...
    'search_products_uppliers' => 'Search Services',
    'hot_categories' => 'Pro Services',
    'legal_name' => 'Legal name',
    'std_shipping_carrier' => 'Standard Delivery Method',
    ...
    'change_shipping_location' => 'Change the billing country, It may change the available delivery options and cost of delivery.',
    //mobile-menu
    'settings' => 'Settings',
	...
	// 1 nov 2022
	'where_should_we_send_the_ebook' => 'Where should we send the Ebook?',
    'by_signing_up_tutorials' => '*By signing up, you agree to receive :web_name tutorials and special offers from :web_name',
    'available_in_pdf' => 'Available in Pdf',
    'video_guide' => 'Video Guide',
    'almost_done_page_title' => 'Please verify your are not robot',
    'almost_done' => 'Almost Done',
    'almost_done_robot_message' => 'To confirm your request, please check the box to let us know you\'re human (sorry, no robots allowed)!',
    'book_my_consultation_page_title' => 'Book My Consultation',
    'skip_n_get_guide' => 'SKIP & GET GUIDE',
    'ready_to_start_your_own_business' => 'READY TO START YOUR OWN BUSINESS?',
    'let_us_give_you_a_hand' => 'Let us give you a hand!',
    'we_can_wait_to_share_experience' => 'We can\'t wait to share our vast experience and help you build your own successful venture. Your consultation is 100% FREE.',
    'book_my_consultation' => 'Book My Consultation',
    // 'thank_you_page_title' => 'Thank You',
    'thank_you_for_the_interest_for_ebook_title' => 'Thank You For The Interest To Our FREE Ebook ":title"',
    'we_have_sent_the_dwonload_link_to_email' => 'We\'ve sent the download link to your email, but you can also get the Ebook right here.',
    'ready_to_start_your_own_bussiness' => 'Ready to start your own business?',
    'choose_from_our_leads_for_subscribe_only' => 'Choose from our deals for subscribers only:',
    'get_a_copy_blooming_services' => 'GET A COPY OF A BOOMING SERVICE',
    'get_a_copy_blooming_service_desc' => 'Want no risk & guesswork? Replicate the success of a highly-profitable dropshipping store!',
    'use_coupon' => 'Use Coupon',
    'save_up_to' => 'Save up to :amount',
    'for_a_discount' => 'For a :value disount',
    'join_us_on_social_media_to_see_success_stories' => 'Join us on social media to see success stories, special offers and project news:',
	...
	'download_our_free_guide_and_lift_your_business' => 'Download our FREE Guides and lift your business to the next level! Get detailed tutorials how to start, run and promote your dropshipping store ',
	'guide_leads' => 'Guide Leads',
	'where_should_we_send_the_guide' => 'Where should we send the guide?',
	'where_should_we_send_the_ebook' => 'Where should we send the Ebook?',
	'helpful_guides_for_business' => 'Helpful Guides for Business',
	
	// 9 nov 2022
	'rating_breakdown' => 'Rating Breakdown',
	'reviews_2' => ':count Reviews',
	'seller_communication_level' => 'Seller Communication Level',
	'recommend_to_a_friend' => 'Recommend to a Friend',
	'service_as_descrived' => 'Service as Descrived',
