...
// route added by hassan00942 + taskAddGuideLead00942
Route::post('/contact_us_consultation', [
    ContactUsController::class, 'send_consultation'
])->name('contact_us_consultation');
