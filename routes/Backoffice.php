...
Route::middleware('auth')->name('admin.')->prefix('admin')->group(function () {
    ...
    Route::middleware(['merchant'])->group(function () {
        ...
        include 'admin/ShopAppearance.php'; // added by hassan00942g + taskShopPageUi00942
    });
    ...
    Route::middleware(['subscribed', 'checkBillingInfo'])->group(function () {
        ...
        Route::name('catalog.')->prefix('catalog')->group(function () {
            ...
            include 'admin/AmongMyBrand.php'; // added by hassan00942
        });
...
//            include 'admin/Packaging.php';
        ...
        Route::name('utility.')->prefix('utility')->group(function () {
            ...
            include 'admin/TeamMember.php'; // added by hassan00942 + teamPage00942
            include 'admin/GuideLead.php'; // added by hassan00942
            include 'admin/FakeReview.php'; // added by hassan00942 + other deveoper work + not on tiejet.net
        ...
        Route::name('setting.')->prefix('setting')->group(function () {
            ...
            include 'admin/CountryWiseWebsite.php'; // added by hassan00942
