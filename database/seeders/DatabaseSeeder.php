...
class DatabaseSeeder extends BaseSeeder
{
    ...
    public function run()
    {
		...
		// added by hassab00942 + uncomment me for fressh installation after adding seeders files
        // $this->call(ModulesAmongMyBrandSeeder::class);
        // $this->call(PermissionsAmongMyBrandSeeder::class);
        // $this->call(ModulesGuideLeadSeeder::class);
        // $this->call(PermissionsGuideLeadSeeder::class);
        // $this->call(ModulesTeamMemberSeeder::class);
        // $this->call(PermissionsTeamMemberSeeder::class);
        // $this->call(ModulesTeamPageSettingSeeder::class);
        // $this->call(PermissionsTeamPageSettingSeeder::class);
