...
@php
  $user_name = auth()->guard('customer')->check() ? auth()->guard('customer')->user()->name : '';
@endphp
{{-- it is dummy + added by hassan00942 --}}
<div class="form-group">
  <div class="input-group">
    <span class="input-group-addon flat"><i class="fas fa-user"></i></span>
    {!! Form::text('cc_name', $user_name, ['id' => '', 'class' => 'form-control flat', 'placeholder' => trans('guestCheckout::lang.address_title') . '*', 'required']) !!}
  </div>
