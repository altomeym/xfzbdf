...
class ListHelper
{
     ...
     */
    /*
        This function has been added by hassan00942
    */
    public static function cache_country_wise_websites()
    {
        return Cache::remember('cache_country_wise_websites', null, function () {
            return CountryWiseWebsite::with('country')->get();
        });
    }
