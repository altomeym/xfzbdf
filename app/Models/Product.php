...
class Product extends BaseModel
{
    ...
    protected $fillable = [
        ...
        'requires_shipping',
        'downloadable',
        'out_source_link', // outsourcing link by hassan00942
        'video_link', // video link by hassan00942
        'slug',
        // 'meta_title',
        // 'meta_description',
        'sale_count',
    ...
    /**
     * Get the inventory for the product. + hassan00942 + taskShopPageUi00942
     */
    
    public function inventory()
    {
        return $this->hasOne(Inventory::class)->orderBy('sale_price','ASC');//->orderBy('offer_price','ASC');
    }

    /**
     * Get the product faqs for the product.
    ...
    /**
     * Get the product questions for the product.
     * fiverLikeAddingProduct00942
     */
