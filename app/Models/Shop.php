...
class Shop extends BaseModel
{
    ...
    /**
     * added by hassan00942
     * Set the fake reviews count for the shop.
     */
    public function getFakeReviewCountAttribute()
    {
        return DB::table('fake_reviews')->count();
    }

    /**
     * added by hassan00942
     * Set the fake reviews averag for the shop.
     */
    public function getFakeReviewRatingAttribute()
    {
        return floatval(DB::table('fake_reviews')->avg('rating'));
    }
