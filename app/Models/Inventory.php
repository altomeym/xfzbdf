...
class Inventory extends BaseModel
{
    ...
    protected $fillable = [
        ...
        'shipping_weight',
        'free_shipping',
        'delivery_days', // fiverLikeAddingProduct00942
        'stuff_pick',
        'available_from',
        'expiry_date',
        'min_order_quantity',
     ...
     * reviewUiLookLikeFiver00942
     */
    public function feedback_breakdowns()
    {
        return $this->hasMany(FeedbackBreakdown::class);
    }
    ...
    /**
     * Get the Fetures for the inventory.
     * fiverLikeAddingProduct00942 + hassan00942
     */
    public function feature_inventory()
    {
        return $this->hasOne(FeatureInventory::class);
    }


    /**
     * Get the Fetures for the inventory.
     * fiverLikeAddingProduct00942 + hassan00942 + not working
     */
    public function features()
    {
        return $this->belongsToMany(Feature::class, 'feature_inventory')
            ->withPivot('feature_value_id')->withTimestamps();
    }

    
    /**
     * Get the feature values that owns the SubGroup.
     * fiverLikeAddingProduct00942 + hassan00942 + not working
     */
    public function featureValues()
    {
        return $this->belongsToMany(FeatureValue::class, 'feature_inventory')
            ->withPivot('feature_id')->withTimestamps();
    }
