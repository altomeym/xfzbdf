...
class RepositoryServiceProvider extends ServiceProvider
{
    public function register()
    {
        ...
        $this->app->singleton(
            \App\Repositories\AmongMyBrand\AmongMyBrandRepository::class,
            \App\Repositories\AmongMyBrand\EloquentAmongMyBrand::class
        );
        $this->app->singleton(
        ...
        $this->app->singleton(
            \Incevio\Package\Coupons\Repositories\CouponRepository::class,
            \Incevio\Package\Coupons\Repositories\EloquentCoupon::class
        );
        $this->app->singleton(
        ...
        $this->app->singleton(
            \App\Repositories\TeamMember\TeamMemberRepository::class,
            \App\Repositories\TeamMember\EloquentTeamMember::class
        );
        // added by hassan00942 + teamPage00942
        $this->app->singleton(
            \App\Repositories\TeamPageSetting\TeamPageSettingRepository::class,
            \App\Repositories\TeamPageSetting\EloquentTeamPageSetting::class
        );
        // added by hassan00942 + taskAddGuideLead00942
        $this->app->singleton(
            \App\Repositories\GuideLead\GuideLeadRepository::class,
            \App\Repositories\GuideLead\EloquentGuideLead::class
        );

        // added by hassan00942 + taskShopPageUi00942
        $this->app->singleton(
            \App\Repositories\ShopAppearance\ShopAppearanceRepository::class,
            \App\Repositories\ShopAppearance\EloquentShopAppearance::class
        );
