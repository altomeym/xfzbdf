    ...
    */
    ...
    public function register(Request $request)
    {
        ...
        $data = [
			...
			'country_id' => $request->input('country_id'), // added by hassan00942 + reviewUiLookLikeFiver00942
		...
		// added by hassan00942 for first login detect
        \Session::put('register-success','yes');
