...
class ProductFeedbackCreateRequest extends Request
{
    ...
    public function rules()
    {
        ...
        return [
			...
			// three lines added by hassan00942 + reviewUiLookLikeFiver00942
            'items.*.rating_seller_communication_level' => 'required|integer|between:1,5',
            'items.*.rating_recommend_to_a_friend' => 'required|integer|between:1,5',
            'items.*.rating_service_as_described' => 'required|integer|between:1,5',
        ];
    }
